...
//  Project20
//
//  Created by Christopher Weirup on 2019-05-10.
...
class GameScene: SKScene {
    ...
    var launches = 10 {
        didSet {
            launchesLabel.text = "Launches Remaining: \(launches)"
        }
    }
    ...
    override func didMove(to view: SKView) {
        ...
        launchesLabel = SKLabelNode(fontNamed: "Avenir-Black")
        launchesLabel.position = CGPoint(x: 1008, y: 16)
        launchesLabel.horizontalAlignmentMode = .right
        launchesLabel.text = "Launches Remaining: 10"
    ...
    func explode(firework: SKNode) {
        ...
        let remove = SKAction.run { explodeEmitter.removeFromParent() }
