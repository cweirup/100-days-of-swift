...
//  Project8
//
//  Created by Weirup, Chris on 2019-04-04.
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        // Challenge 1 - Add thin gray line around buttons view
    ...
    func loadLevel() {
        ...
        DispatchQueue.global(qos: .userInitiated).async { [weak self] in
            ...
            let newLevel = self?.level ?? 1
            
            if let levelFileURL = Bundle.main.url(forResource: "level\(newLevel)", withExtension: "txt") {
            ...
            self?.updateLabels(clue: clueString, solution: solutionString, letters: letterBits)
        }
        
    }
    
    func updateLabels(clue: String, solution: String, letters: [String]) {
        DispatchQueue.main.async {
            ...
            if let letterCount = self?.letterButtons.count {
