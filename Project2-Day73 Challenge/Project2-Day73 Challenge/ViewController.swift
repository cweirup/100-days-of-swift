...
class ViewController: UIViewController, UNUserNotificationCenterDelegate {
    ...
    @objc func scheduleLocal() {
        ...
        content.body = "Time to play the flag game! Get going!"
    ...
    func registerCategories() {
        ...
        let play = UNNotificationAction(identifier: "plan", title: "Play game", options: .foreground)
